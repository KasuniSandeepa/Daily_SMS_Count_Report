...
<title>Monthly Table Report | Textware Daily SMS Report</title>
		...
		<div class="main-panel">
			...
			<div class="container">
				<ul class="nav nav-tabs" role="tablist">
					<li class="nav-item"><a
						class="nav-link active {{request () -> is('ViewSummaryByMonth.jsp') ? 'active' : null }}"
						href="ViewSummaryByMonth.jsp" role="tab" style="color: #808080">View
							Summary By Month</a></li>
					<li class="nav-item"><a
						class="nav-link {{request () -> is('View_2.jsp') ? 'active' : null }}"
			...
			<div class="container">
				...
				<form action="ViewSummaryByMonth.jsp" name="add" method="post">
...
<input type="submit" value="View"
				...
				<h3><%=year%>        <%=months[Integer.parseInt(monthNumber)-1]%></h3>
