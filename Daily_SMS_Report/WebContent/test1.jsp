...
ArrayList<Account> accNames = new ArrayList();
	...
	for (int i = 0; i < maxDay; i++) {
   		...
   		for(String var : newAccountNames){
    	ArrayList<Account> accounts = db.ViewDatabyMonthDateName(month, var , String.valueOf(i+1));
...
%>
	<div class="container">
		<div class="text-center"></div>
			...
			<form action="test1.jsp"  name="add" method="post">
					...
					<tr>
						   ...
						   for (Map.Entry<String, List<Data>> entry : entries) {
						          ...
						          if(entry.getValue().size()==0){
						              ...
						              for (Data datas : entry.getValue()) {
						                //  System.out.println(datas.toString());
						                  if(datas.getName().equals(newAccountNames.get(i))){
						                	  %>
