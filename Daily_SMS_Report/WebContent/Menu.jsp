...
<body>
    ...
    <div class="container-lg pt-5">
        ...
        <!--Charts-->
    			 ...
    			 <!--BarCharts Per Month-->
                <div class="card" style="height:15rem; width: 15rem; background-color:#ffffcc">
           
                <div class="card-body">
                    <h4 class="card-title" style="align:center;"><center>Top 20 Clients</center></h4>
               <br><br>
                  <center>  <a href="BarChartMonth.jsp" class="btn btn-primary">Enter</a></center>
                </div>
            </div>
             ...
             <div class="card" style="height:15rem; width: 15rem; background-color:#ffffcc">
                ...
                <div class="card-body">
                   <center> <h4 class="card-title">Line Chart for All clients</h4></center>
                <br>
                 <center>  <a href="LineChartByMonth.jsp" class="btn btn-primary">Enter</a> <center> 
                </div>
            </div>
            ...
            <div class="card" style="height:15rem; width: 15rem; background-color:#ffffcc">
                ...
                <div class="card-body">
                    <h4 class="card-title" style="align:center;"><center>Line Chart Summary  for the Year</center></h4>
                    <br>
                  <center>  <a href="LineChartPerYear2.jsp" class="btn btn-primary">Enter</a></center>
                </div>
            </div>
    
    
                        
           <!--Line Chart for the Message Count-->
          <div class="card" style="height:15rem; width: 15rem; background-color:#ffffcc">

                <div class="card-body">
                    <center><h4 class="card-title">Line Chart for the Message Amount (Year Analysis)</h4></center>
                  <br>
                    <center>    <a href="LineChartByYear1.jsp" class="btn btn-primary">Enter</a></center>
                </div>
            </div>
        </div>
        <br>
