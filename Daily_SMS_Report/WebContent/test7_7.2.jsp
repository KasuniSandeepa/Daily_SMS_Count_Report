...
<body>
	...
	<div class="container">
		...
		<form action="test7_7.2.jsp" name="add" method="post">
			<div class="input-group">
			 ...
			 Month &nbsp;&nbsp;<select
				...
				</select>&nbsp;&nbsp;&nbsp;&nbsp; <input type="submit" value="View" style="background-color: #008CBA ; padding: 6px 14px; border-radius: 4px; color: white;"/>
