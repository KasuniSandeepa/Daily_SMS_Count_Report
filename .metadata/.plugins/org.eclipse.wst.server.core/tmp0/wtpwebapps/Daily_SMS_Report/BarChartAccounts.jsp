...
<body>
	...
	try {
		...
		String _Sql = "SELECT Account_Name ,  sum(Msg_Count) FROM daily_sms_report.account group by Account_Name order by sum(Msg_Count) DESC limit 20";
	...
	<script>
		window.onload = function() {
			...
			var chart = new CanvasJS.Chart("chartContainer", {
				theme : "light10",
				title : {
					text : "Bar Chart of top 20 clients"
				},
				axisX : {
					title : "Account Name"
				},
