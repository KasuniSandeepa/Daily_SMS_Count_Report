...
<body>
	...
	<div class="container">
		...
		<form action="Controller/view_controller4.jsp" name="add"
			method="post">
	...
	<table class="table table-fluid" id="myTable">
		...
		<tbody>
			...
			<%
				ArrayList<Account> accounts = (ArrayList<Account>) request.getAttribute("accountsCount");
			int c = 0;
			String name = null;
			%>
			...
			<c:forEach var="accountNames" items="${accountNames}">
				...
				<tr>
					...
					<c:forEach var="accountsCount" items="${accountsCount}">
						<c:forEach var="dates" items="${dates}">
							<c:if
								test="${accountsCount.getAccountName() == accountNames && accountsCount.getDate()==dates}">
