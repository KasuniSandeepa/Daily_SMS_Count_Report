...
<body>
	...
	connection = DBConnection.GetConnection();
		...
		String _Sql = "SELECT Account_Name , Month(Date) , sum(Msg_Count) FROM daily_sms_report.account group by MONTH(Date) , year(Date) ,  Account_Name order by sum(Msg_Count) DESC LIMIT 20";
