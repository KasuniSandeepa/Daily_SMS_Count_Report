...
<title>Daily Table Report | Daily SMS Report</title>
<meta
			...
			<div class="sidebar-wrapper">
				...
				<ul class="nav">
					...
					<li class="nav-item active"><a class="nav-link"
						href="ViewSummaryByMonth.jsp"> <i class="nc-icon nc-notes"></i>
							<p>Table List</p>
					</a></li>
					...
					<li><a class="nav-link" href="upload.jsp"> <i
		...
		<div class="main-panel">
			...
			<nav class="navbar navbar-expand-lg " color-on-scroll="500">
				<div class="container-fluid">
					<a class="navbar-brand" href="#pablo"> Table Report - Per Date</a>
			...
			<div class="container">
				<ul class="nav nav-tabs" role="tablist">
					<li class="nav-item"><a
						class="nav-link {{request () -> is('ViewSummaryByMonth.jsp') ? 'active' : null }}"
						href="ViewSummaryByMonth.jsp" role="tab" style="color: #808080">View
							Summary By Month</a></li>
					<li class="nav-item"><a
						class="nav-link active {{request () -> is('View_2.jsp') ? 'active' : null }}"
						href="View_2.jsp" role="tab" style="color: #808080">View
							Summary By Date</a></li>

					<li class="nav-item"><a
						class="nav-link   {{request () -> is('test7_7.1.jsp') ? 'active' : null }}"
						href="test7_7.1.jsp" role="tab" style="color: #808080">Overall
							View</a></li>
				...
				<div class="tab-content">
					<div
						class="tab-pane {{request() ->is('ViewSummaryByMonth.jsp') ? 'active' : null }}"
						id="{{url('ViewSummaryByMonth.jsp')}}" role="tabpanel">
						<p>View Summary By Month</p>
					</div>
					<div
						class="tab-pane {{request() ->is('View_2.jsp') ? 'active' : null }}"
						id="{{url('View_2.jsp')}}" role="tabpanel">
						<p>View Summary By Date</p>
					</div>

					<div
						class="tab-pane {{request() ->is('test7_7.1.jsp') ? 'active' : null }}"
						id="{{url('test7_7.1.jsp')}}" role="tabpanel">
						<p>Overall View</p>
					</div>
				...
				<form action="Controller/view_controller2.jsp" name="add"
					...
					<div class="input-group">
						...
						&nbsp;&nbsp;&nbsp; <input type="submit" value="View"
							style="background-color: #008CBA; padding: 6px 14px; border-radius: 4px; color: white;" />
				</form>

				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<!--  <a href="ChartbyDate.jsp"><input type="button" class="btn btn-warning"
							value="View Chart"></a>-->
			</div>
