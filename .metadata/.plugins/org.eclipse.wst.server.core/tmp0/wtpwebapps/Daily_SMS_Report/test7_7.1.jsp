...
<link rel="stylesheet" href="http://code.jquery.com/ui/1.10.4/themes/smoothness/jquery-ui.css">
  ...
  <script src="http://code.jquery.com/ui/1.10.4/jquery-ui.js"></script>
   <link rel="apple-touch-icon" sizes="76x76" href="./assets/img/apple-icon.png">
    ...
    <title>Main Table Report | Daily SMS Report</title>
...
<body>
    ...
    -->
        ...
        <div class="main-panel">
            <!-- Navbar -->
            <nav class="navbar navbar-expand-lg " color-on-scroll="500" style="color: #808080">
	...
	<br>
	 <div class="container">
          <ul class="nav nav-tabs" role="tablist">
	          <li class="nav-item">
		          <a class="nav-link {{request () -> is('ViewSummaryByMonth.jsp') ? 'active' : null }}"  href="ViewSummaryByMonth.jsp" role="tab" style="color: #808080">View Summary By Month</a>
	          </li>
	          <li class="nav-item">
		        <a class="nav-link {{request () -> is('View_2.jsp') ? 'active' : null }}" href="View_2.jsp" role="tab" style="color: #808080">View Summary By Date</a>
	          </li>
	          
	            <li class="nav-item">
		        <a class="nav-link  active {{request () -> is('test7_7.1.jsp') ? 'active' : null }}" href="test7_7.1.jsp" role="tab" style="color: #808080">Overall View</a>
	          </li>
	
          </ul><!-- Tab panes -->
        <div class="tab-content">
	<div class="tab-pane {{request() ->is('ViewSummaryByMonth.jsp') ? 'active' : null }}" id="{{url('ViewSummaryByMonth.jsp')}}" role="tabpanel">
		<p>View Summary By Month</p>
	</div>
	<div class="tab-pane {{request() ->is('View_2.jsp') ? 'active' : null }}" id="{{url('View_2.jsp')}}" role="tabpanel">
		<p>View Summary By Date</p>
	</div>
	<div class="tab-pane {{request() ->is('test7_7.1.jsp') ? 'active' : null }}" id="{{url('test7_7.1.jsp')}}" role="tabpanel">
		<p>Overall View</p>
	</div>
	...
	<div class="container">
		...
		<form action="test7_7.1.jsp" name="add" method="post">
			<div class="input-group">

				Year &nbsp;&nbsp; <select 
					id="ddlYears" name="year"></select> &nbsp;&nbsp;&nbsp;&nbsp; 
			 Month &nbsp;&nbsp;<select
				...
				</select>&nbsp;&nbsp;&nbsp;&nbsp; <input type="submit" value="View" style="background-color: #008CBA ; padding: 6px 10px; border-radius: 4px; color: white;"/>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<h3><%=year%>        <%=months[Integer.parseInt(month)-1]%></h3>
 ...
 <div id="" title="Basic dialog">
	...
	function passData(name , month , year){
		...
		//window.location = "1.jsp?"+name;
			...
			location.assign("2_2.jsp?name11="+array);
