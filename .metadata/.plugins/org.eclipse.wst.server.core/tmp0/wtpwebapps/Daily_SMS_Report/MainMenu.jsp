...
<body>
    ...
    <div class="container-lg pt-5">
      ...
      <!--Chart Summary-->
                ...
                <div class="card-body">
                    <h4 class="card-title" style="align:center;"><center>Chart Summary</center></h4>
                    <br><br>
                  <center>  <a href="Menu.jsp" class="btn btn-primary">Enter</a></center>
                </div>
            </div>
             ...
             <div class="card" style="height:15rem; width: 15rem; background-color:#ffffcc">
                ...
                <div class="card-body">
                   <center> <h4 class="card-title">Table Summary</h4></center>
                 <br>
                 <center>  <a href="TableMenu.jsp" class="btn btn-primary">Enter</a> <center> 
                </div>
            </div>
             ...
             <div class="card" style="height:15rem; width: 15rem; background-color:#ffffcc">
                ...
                <div class="card-body">
                   <center> <h4 class="card-title">Enter the Date to show total amount of messages</h4></center>
                 <br>
                 <center>  <a href="View3.jsp" class="btn btn-primary">Enter</a> <center> 
                </div>
            </div>
