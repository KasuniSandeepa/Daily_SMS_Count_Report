...
<body>
	...
	<br>
	<div class="container">
		<form action="LineChartPerYear4.jsp" name="add" method="post">
	...
	for (Account value : _AccountDetails) {
		...
		monthsAvailable.add(value.getDate());
	}
	...
	for (int i = 0; i < months.length; i++) {
		for(Account value : _AccountDetails) {
			...
			if(value.getAccountName().equals("2021")){
				int tempI = i + 1;
					int month = Integer.parseInt(value.getDate());
			...
			if(value.getAccountName().equals("2018")){
				int tempI = i + 1;
					int month = Integer.parseInt(value.getDate());
	...
	for(Map e : newList){
		System.out.println("nnnnnnnnnnnn"+e);
	...
	for(Map e : newList){
		System.out.println("mmmmmmmmmmmmmmmmmmmmmm"+e);
		//System.out.println(e.get("label"));
		//System.out.println(e.values());
