...
<body>
			...
			<div class="container" class="width:100%">
				...
				<div id="navbarResponsive">
					...
					<ul class="u">
						...
						<li class="l">
						<li class="l"><a
							class="nav-link text-uppercase text-expanded"  id="active" href="MainMenu.jsp">View</a></li>
						</li>
						</li>
	...
	<div class="container">
		...
		<form action="test8.jsp" name="add" method="post">
 ...
 <div id="" title="Basic dialog">
	...
	<table class="table table-striped" id="myTable">
		...
		<tbody>
			...
			<tr data-id="<%=newAccountNames.get(i)%>" data-toggle="modal" data-target="#exampleModalCenter">
	...
	function passData(name , month , year){
		...
		//window.location = "1.jsp?"+name;
			...
			location.assign("#exampleModalCenter");
  ...
  /* $(document).on("click", ".open-modal", function () {
    ...
    $(function(){
        $('#exampleModalCenter').modal({
            ...
            $(this).find('#orderDetails').html($('<b> Order Id selected</b>'))
        });
    });
