				...
				<div id="navbarResponsive">
					...
					<ul class="u">
						...
						<li class="l"><a
							...
							href="MainMenu.jsp.jsp">View</a></li>
						</li>
				</div>
				</ul>
...
ArrayList<Account> _AccountDetails = new ArrayList<>();
		...
		//	String _Sql = "select * from  totalcountmonthlychart where Month= ' " + monthNumber + " ' order by  SumMsgCount desc LIMIT 20";
			String _Sql = "SELECT Year(Date) , sum(Msg_Count) FROM daily_sms_report.account group by Year(Date)";
...
System.out.println( _AccountDetails);
...
try{
		...
		for (Account value :   _AccountDetails) {
			...
			String _yearNumber = value.getAccountName();
			...
			map = new HashMap<Object, Object>();map.put("label",  _yearNumber);map.put("y", MsgCount);list.add(map);
...
System.out.println("kkkkkkkk"+list);
